...
var scatterChart = function () {
    return {
        ...
        setData: function (myData) {
            ...
            var colors = ["#24dbdb", "#6791ff", "#23aaff", "#23aaff", "#72c312", "#5be93f"];
            var colorsD = ["#37b1ff", "#476eff", "#4070db", "#4070db", "#7ddf08", "#008934"];
			...
			var dx = Math.round(me._width/data.length)-5;
//			var dy = me._height/2;
			console.log(dx)
            var node = me._svg.selectAll(".node")
                ...
                .attr("transform", function (d,i) {
                    return "translate(" + (dx*i+45) + "," + (110*(i%2)+100) + ")";
                });
